...
MIDDLEWARE = [
    ...
    # 'sid.middlewares.UnderConstructionMiddleware',
]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'sudarshankakde1111@gmail.com'  # Enter your email
EMAIL_HOST_PASSWORD = 'hoayanhjmpnngifq'  # Enter the password to the email


JAZZMIN_SETTINGS = {
    # title of the window (Will default to current_admin_site.site_title if absent or None)
    "site_title": "Sids Blog Admin",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Sids Blog",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Sids Blog",
    ...
    "welcome_sign": "Welcome to the Sid Blogs",

    # Copyright on the footer
    "copyright": "Sid's Blog",
